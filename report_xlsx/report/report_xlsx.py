...
class ReportXlsx(report_sxw):
    ...
    def create_xlsx_report(self, ids, data, report):
        ...
        if self.parser_instance.objects and objs and objs._name==self.parser_instance.objects._name \
                and objs.ids!=self.parser_instance.objects.ids:
            objs = self.parser_instance.objects
        file_data = StringIO()
